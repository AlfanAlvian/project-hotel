            ...
            <div class="card-body m-2">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tipe_kamar" required maxlength="50"/>
                    </div>
                    <div class="form-group">
                        <label for="jumlah_kamar">Jumlah Kamar</label>
                        <input type="number" min="1" max="3" class="form-control" name="jumlah_kamar" 
                        placeholder="Jumlah kamar" required>
                    </div>
                    <div class="form-group">
                        <label for="fasilitas_kamar">Fasilitas Kamar</label>
                       <input type="hidden" class="form-control" name="fasilitas_kamar">
